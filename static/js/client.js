...
const doneHtml = "<button class='entry-item done-button hide waves-effect waves-light btn purple darken-1' name='action' value='DONE'>Done</button>";
const helpHtml = "<button class='entry-item help-button hide waves-effect waves-light btn purple darken-1' name='action' value='HELP'>Help</button>";
        ...
        if (ta_id) {
            ...
            if (entry.update_requested) {
                elt.find(".help-button")
                    .removeClass("waves-light btn purple darken-1")
    ...
    $("#queue li").each(function(index, item) {
        if ($(item).data("entryId") == message.id) {
            ...
            if (!ta_helping_id) {
                $(item).find(".remove-button").removeClass("hide");
                $(item).find(".help-button").removeClass("hide")
                    .addClass("waves-light btn purple darken-1")
